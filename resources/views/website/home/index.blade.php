    ...
    <section id="hero">
        <div class="hero-container">
            <a href="https://aitvet-edu-html.vercel.app/" class="hero-logo" data-aos="zoom-in"><img
                    src="{{asset('/')}}website/assets/img/hero-logo.png" alt=""></a>
                            ...
                            <div class="col-lg-6" data-aos="fade-right">
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active show" id="tab-1">
                                        <figure>
                                            <img src="{{asset('/')}}website/assets/img/program/architecture.jpg" alt="" class="img-fluid">
                                        </figure>
                                    </div>

                                    <div class="tab-pane" id="tab-2">
                                        <figure>
                                            <img src="{{asset('/')}}website/assets/img/program/chemical.jpg" alt="" class="img-fluid">
                                        </figure>
                                    </div>

                                    <div class="tab-pane" id="tab-3">
                                        <figure>
                                            <img src="{{asset('/')}}website/assets/img/program/civil.jpg" alt="" class="img-fluid">
                                        </figure>
                                    </div>

                                    <div class="tab-pane" id="tab-4">
                                        <figure>
                                            <img src="{{asset('/')}}website/assets/img/program/computer.jpg" alt="" class="img-fluid">
                                        </figure>
                                    </div>

                                    <div class="tab-pane" id="tab-5">
                                        <figure>
                                            <img src="{{asset('/')}}website/assets/img/program/electrical.jpg" alt=""
                                                class="img-fluid">
                                        </figure>
                                    </div>
                                    ...
                                    <div class="tab-pane" id="tab-6">
                                        <figure>
                                            <img src="{{asset('/')}}website/assets/img/program/electronics.jpg" alt=""
                                                class="img-fluid">
                                        </figure>
                                    </div>
                                    ...
                                    <div class="tab-pane" id="tab-7">
                                        <figure>
                                            <img src="{{asset('/')}}website/assets/img/program/textile.jpg" alt="" class="img-fluid">
                                        </figure>
                                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 order-1 order-lg-2 align-items-stretch video-box"
                        style='background-image: url("{{asset('/')}}website/assets/img/why-us-1.png");' data-aos="zoom-in">
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item ">
                        <div class="portfolio-wrap">
                            <img src="{{asset('/')}}website/assets/img/portfolio/arc.jpg" class="img-fluid" alt="">
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item ">
                        <div class="portfolio-wrap">
                            <img src="{{asset('/')}}website/assets/img/portfolio/chem.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="member-info">
                            <h4>Chemical Technology</h4>
                            <div class="text-right">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item ">
                        <div class="portfolio-wrap">
                            <img src="{{asset('/')}}website/assets/img/portfolio/civi.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="member-info">
                            <h4>Civil Technology</h4>
                            <div class="text-right">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item ">
                        <div class="portfolio-wrap">
                            <img src="{{asset('/')}}website/assets/img/portfolio/cmt.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="member-info">
                            <h4>Computer Technology</h4>
                            <div class="text-right">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item ">
                        <div class="portfolio-wrap">
                            <img src="{{asset('/')}}website/assets/img/portfolio/eee.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="member-info">
                            <h4>Electrical Technology</h4>
                            <div class="text-right">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item ">
                        <div class="portfolio-wrap">
                            <img src="{{asset('/')}}website/assets/img/portfolio/eec.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="member-info">
                            <h4>Electronics Technology</h4>
                            <div class="text-right">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item ">
                        <div class="portfolio-wrap">
                            <img src="{{asset('/')}}website/assets/img/portfolio/txt.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="member-info">
                            <h4>Textile Technology</h4>
                            <div class="text-right">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <img src="{{asset('/')}}website/assets/img/testimonials/cmt-1.jpg" class="testimonial-img" alt="">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <img src="{{asset('/')}}website/assets//img/testimonials/cmt-2.jpg" class="testimonial-img" alt="">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <img src="{{asset('/')}}website/assets/img/testimonials/testimonials-2.jpg" class="testimonial-img"
                                    alt="">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <img src="{{asset('/')}}website/assets/img/testimonials/testimonials-3.jpg" class="testimonial-img"
                                    alt="">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <img src="{{asset('/')}}website/assets/img/testimonials/testimonials-4.jpg" class="testimonial-img"
                                    alt="">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <img src="{{asset('/')}}website/assets/img/testimonials/testimonials-5.jpg" class="testimonial-img"
                                    alt="">
                ...
                <div class="principle-content col-lg-4 col-md-12 d-flex align-items-stretch">
                    <div class="principle" data-aos="zoom-in">
                        <div class="member-img">
                            <img src="{{asset('/')}}website/assets/img/team/principle.jpg" width="100%" height="400px" alt="">
                        </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <h5 class="title mb-1"><a style="color: #7cc576;"
                                                        href="page/single-notice.html">Notice about Receiving Merit
                                                        Scholarship
                                                        Checks</a>
                                                </h5>
                                                <div class="meta mb-1"><span class="date">Published by <a
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 mt-5 mt-lg-0">
                        ...
                        <form action="{{asset('/')}}website/assets/forms/contact.php" method="post" role="form" class="php-email-form"
                            data-aos="fade-left">
                            <div class="row">
