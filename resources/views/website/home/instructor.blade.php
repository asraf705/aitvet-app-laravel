            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/pri-1.jpg"
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/arc-1.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="100">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/arc-2.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                                <h4>Farah Yasmin</h4>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/chmi-1.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/civi-1.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/civi-2.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/civi-3.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                                <h4>Sabina Yesmin</h4>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/civi-4.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/civi-5.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/cmt-1.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                                <h4>Afsana Hamid</h4>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/cmt-2.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/cmt-3.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/cmt-4.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/cmt-5.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/cmt-6.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/cmt-7.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/cmt-8.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/eee-1.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                                <h4>A. N. M.Hossain</h4>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/eee-2.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/eee-3.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/eee-4.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/eee-5.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/eee-6.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/eee-7.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/eee-8.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/eec-1.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/eec-2.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/eec-3.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/eec-4.png"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/txt-1.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                                <h4>Riffat Islam</h4>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/txt-2.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                                <h4>Md. Sobur Khan</h4>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/txt-3.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/txt-4.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                                <h4>S. M. Abu Sayem</h4>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/rel-1.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/rel-2.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/rel-3.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/rel-4.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                                <h4>Saadni Islam</h4>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/rel-5.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/rel-6.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                                <h4>Lutfa Jahan</h4>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/rel-7.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="zoom-in" data-aos-delay="200">
                            <div class="member-img">
                                <img src="{{ asset('/') }}website/assets/img/instructor/rel-8.jpg"
                                    class=".img-instructor" alt="">
                            </div>
                            <div class="member-info">
