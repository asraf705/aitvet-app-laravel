                                ...
                                <table class="table table-striped">
                                        ...
                                        <td class="text-truncate">
                                            <ul class="list-unstyled order-list m-b-0 m-b-0">
                                                <li class="team-member team-member-sm"><img class="rounded-circle"
                                                        src="{{ asset('/') }}admin/assets/img/users/user-8.png"
                                                        alt="user" data-toggle="tooltip" title=""
                                                        data-original-title="Wildan Ahdian"></li>
                                                <li class="team-member team-member-sm"><img class="rounded-circle"
                                                        src="{{ asset('/') }}admin/assets/img/users/user-9.png"
                                                        alt="user" data-toggle="tooltip" title=""
                                                        data-original-title="John Deo"></li>
                                                <li class="team-member team-member-sm"><img class="rounded-circle"
                                                        src="{{ asset('/') }}admin/assets/img/users/user-10.png"
                                                        alt="user" data-toggle="tooltip" title=""
                                        ...
                                        <td class="text-truncate">
                                            <ul class="list-unstyled order-list m-b-0 m-b-0">
                                                <li class="team-member team-member-sm"><img class="rounded-circle"
                                                        ...
                                                        data-original-title="Wildan Ahdian"></li>
                                                <li class="team-member team-member-sm"><img class="rounded-circle"
                                                        src="{{ asset('/') }}admin/assets/img/users/user-2.png"
                                                        alt="user" data-toggle="tooltip" title=""
                                                        data-original-title="John Deo"></li>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-truncate">
                                            <ul class="list-unstyled order-list m-b-0 m-b-0">
                                                <li class="team-member team-member-sm"><img class="rounded-circle"
                                                        src="{{ asset('/') }}admin/assets/img/users/user-3.png"
                                                        alt="user" data-toggle="tooltip" title=""
                                                        data-original-title="Wildan Ahdian"></li>
                                                <li class="team-member team-member-sm"><img class="rounded-circle"
                                                        src="{{ asset('/') }}admin/assets/img/users/user-4.png"
                                                        alt="user" data-toggle="tooltip" title=""
                                                        data-original-title="John Deo"></li>
                                                <li class="team-member team-member-sm"><img class="rounded-circle"
                                                        src="{{ asset('/') }}admin/assets/img/users/user-5.png"
                                                        alt="user" data-toggle="tooltip" title=""
                                                        data-original-title="Sarah Smith"></li>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-truncate">
                                            <ul class="list-unstyled order-list m-b-0 m-b-0">
                                                <li class="team-member team-member-sm"><img class="rounded-circle"
                                                        src="{{ asset('/') }}admin/assets/img/users/user-7.png"
                                                        alt="user" data-toggle="tooltip" title=""
                                                        data-original-title="John Deo"></li>
                                                <li class="team-member team-member-sm"><img class="rounded-circle"
                                                        src="{{ asset('/') }}admin/assets/img/users/user-8.png"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="support-ticket media pb-1 mb-3">
                                <img src="{{ asset('/') }}admin/assets/img/users/user-1.png" class="user-img mr-2"
                                    alt="">
                            ...
                            <div class="support-ticket media pb-1 mb-3">
                                <img src="{{ asset('/') }}admin/assets/img/users/user-2.png" class="user-img mr-2"
                                    alt="">
                                <div class="media-body ml-3">
                            ...
                            <div class="support-ticket media pb-1 mb-3">
                                <img src="{{ asset('/') }}admin/assets/img/users/user-3.png" class="user-img mr-2"
                                    alt="">
                                <div class="media-body ml-3">
                            ...
                            <div class="support-ticket media pb-1 mb-3">
                                <img src="{{ asset('/') }}admin/assets/img/users/user-6.png" class="user-img mr-2"
                                    alt="">
                                <div class="media-body ml-3">
